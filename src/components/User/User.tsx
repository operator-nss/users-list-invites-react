...
const User: FC<user> = ({id, email, selectUser, selected, first_name, last_name, avatar}) => {
    ...
    return (
        <li>
            ...
            <img onClick={() => selectUser(id)} className="action" src={selected ? minus : plus} alt="Action"/>
